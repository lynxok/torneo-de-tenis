...
-- Fecha: 2026-08-28
-- Versión: 2.0 (Resiliente con auto-creación de tablas auxiliares si no existen)
-- ==============================================================================
...
-- 8. TABLA: BOOKING_WAITLIST (Crear si no existe y habilitar RLS)
...
-- 9. TABLA: MESSAGES (Crear si no existe y habilitar RLS)
...
-- 10. TABLA: SYSTEM_SETTINGS (Crear si no existe y habilitar RLS)
...
-- 11. TABLA: RANKING_HISTORY (Crear si no existe y habilitar RLS)
...
-- 12. TABLA: TRANSACTIONS (Crear si no existe y habilitar RLS)
...
-- 13. TABLA: MATCHMAKING_POSTS (Crear si no existe y habilitar RLS)
...
-- 14. TABLA: STORIES (Crear si no existe y habilitar RLS)
CREATE TABLE IF NOT EXISTS public.stories (
    ...
    expires_at TIMESTAMPTZ DEFAULT timezone('utc'::text, now() + interval '20 hours') NOT NULL
);
