...
import { calculateGroupStandings, calculateUnifiedStandings, organizePlayoffRounds, getProjectedPlayoffRounds, buildPlayoffTreeFromZones, GroupZone, GroupStandingRow, PlayoffRound, ProjectedRound } from '../utils/bracketHelper';
...
export const TournamentDetails: React.FC<TournamentDetailsProps> = ({ tournamentId, user, onBack }) => {
    ...
    const loadTournament = async (showLoadingSpinner = true) => {
        const cached = tournamentDataCache.get(tournamentId) as any;
    ...
    const handleApplyRainDelay = async () => {
        ...
        try {
            ...
            addToast(`🌧️ Demora de ${rainDelayMinutes} min aplicada a ${res} partidos de la jornada`, 'success');
